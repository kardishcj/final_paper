...
Do tradiitonal indicators of voter turnout hold the same predictive power from one generation to the next? Do other potential indicators, such as race or gender, have more predictive power for the Millennial generation? 
...
There are a number of limitations with our analysis and the dataset that was used. Foremost, only using 2012 to gain insight into voting indicators diminshes any external validity. Ideally, panel data would be used to gain more externally valid insights into predictors. Additionally, past voting behavior in this survey, refered to the participants voting behavior in the year of 2008. The 2008 presidential election had record turnout, specifically among millennials and specifically among African-Americans. Using 2008 as a proxy for past voting behavior needs to be looked at critically as it is probably overestimates past voting behavior. 
...
The remaining variance in the model potentially speaks to other, more contextual and systemic variables that are often not looked at in conjuction with individual level indicators. The closeness of the election, contextual socio-economic conditions, and registration laws have an impact on who goes to the polls. Registration laws could be of partiuclar importance as portions of the voting rights act were recently repealled and newly encforced restrictions for registering and voting disporoportionatly hurt minorities. Also, Millennials move more than past generations, Baby Boomers in particular, and in the U.S. context this entails numerous obstacles, such as registering to vote again in the new place of residence '[@benetsky2015young]'.
