...
```
```{r, echo=FALSE, fig.cap='Figure 2: Confidence Intervals of Log Odds'}
...
Additionally, population size and electoral closeness, and population stability also have an influence.  whereas racial diversity was consistently negatively significant. The interplay between individual predictors and systemic predictors has yet to be fully explored.
