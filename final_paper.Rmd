...
Additionally, population size and electoral closeness, racial divesity, and population stability also have an influence. This mulitidude of potential factors is of partiuclar importance in the United States, where the government is highly centralized in some regards, highly decentralized in others, racially diverse, and the aggregate population is quite large. 
 
given Millennials' disdain for the mobilizing effects of party identification. Other variables of interest include civic duty, which we believe will not have as strong of an impact owing to a greater sense of social dislocation among Millennials, which will also contribute to diminished impact of membership in traditional institutions (church, unions, etc.). Because of these factors, Millennials will have to feel an especially strong attachment to a candidate in a given election in order to vote, which is measurable using ANES, and contact from a political party will have an especially high impact [@kitchel2015they].
